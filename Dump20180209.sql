...
--
-- Table structure for table `issue_point`
--

DROP TABLE IF EXISTS `issue_point`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `issue_point` (
  `ip_issue_point_id` smallint(6) NOT NULL AUTO_INCREMENT,
  `ip_adress` varchar(45) DEFAULT NULL COMMENT 'Адрес пункта получения',
  `ip_phone` int(11) DEFAULT NULL,
  PRIMARY KEY (`ip_issue_point_id`),
  UNIQUE KEY `ip_adress_UNIQUE` (`ip_adress`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `issue_point`
--

LOCK TABLES `issue_point` WRITE;
/*!40000 ALTER TABLE `issue_point` DISABLE KEYS */;
INSERT INTO `issue_point` VALUES (1,'г. Минск, проспект Независимости 13',2581478),(2,'г. Минск, проспект Дзержинского 104',3692574),(3,'г. Минск, проспект Партизанский 56',2417535),(4,'г. Минск, улица Кольцова 11',2113399),(5,'г. Минск, улица Притыцкого 78',2668844),(6,'г. Минск, проспект Рокоссовского 64',3451278),(7,'г. Минск, улица Якуба Коласа 9',2897845),(8,'г. Минск, проезд Голодеда 12',2478569),(9,'г. Минск, улица Восточная 116',3471697),(10,'г. Минск, улица Уручская 47',2578931);
/*!40000 ALTER TABLE `issue_point` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `order` (
  ...
  `ip_issue_point_id` smallint(6) NOT NULL DEFAULT '1' COMMENT 'Пункт выдачи заказа',
  `o_total_sum` decimal(10,2) NOT NULL,
  PRIMARY KEY (`o_order_id`),
  KEY `fk_order_user1_idx` (`u_user_id`),
  KEY `fk_order_issue_point1_idx` (`ip_issue_point_id`),
  CONSTRAINT `fk_order_issue_point1` FOREIGN KEY (`ip_issue_point_id`) REFERENCES `issue_point` (`ip_issue_point_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `order` VALUES (1,26,'2017-10-26','ready to receive',1,16.70),(2,2,'2017-10-26','in processing',2,19.38),(3,26,'2017-10-26','paid',1,54.24),(4,13,'2017-10-20','ready to receive',3,23.90),(5,14,'2017-10-26','in processing',5,31.61),(6,15,'2017-10-28','in processing',2,33.09),(7,16,'2017-10-27','in processing',4,21.21),(8,26,'2017-10-25','ready to receive',5,43.17),(9,18,'2017-10-25','in processing',8,29.47),(10,19,'2017-10-25','in processing',9,19.80),(11,20,'2017-10-27','ready to receive',9,47.33),(12,26,'2017-10-25','in processing',9,19.22),(13,15,'2017-10-25','ready to receive',3,7.09),(14,26,'2018-02-02','paid',1,22.73),(15,26,'2018-02-02','paid',1,8.04),(16,26,'2018-02-02','paid',1,24.30),(17,26,'2018-02-02','paid',1,4.50),(18,26,'2018-02-02','paid',1,9.43),(20,26,'2018-02-04','paid',1,18.05),(21,26,'2018-02-04','paid',1,18.05),(22,26,'2018-02-05','paid',1,9.43),(23,26,'2018-02-08','paid',1,12.30);
...
CREATE TABLE `order_detail` (
  ...
  CONSTRAINT `fk_order_detail_order1` FOREIGN KEY (`o_order_id`) REFERENCES `order` (`o_order_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2018-02-09 18:44:57
