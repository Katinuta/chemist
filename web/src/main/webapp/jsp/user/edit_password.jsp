                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
                    ...
                    <div class="container-fluid form shadow">
                        ...
                        <form action="user" method="post">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" id="password" name="password" required value="${fn:escapeXml(password)}"
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" id="new_password" name="new_password" value="${fn:escapeXml(new_password)}"
