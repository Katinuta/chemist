...
<html>
    <head>
        ...
        <script type="application/javascript" src="/js/medicine_edit.js"></script>
    </head>
    <body>
                    ...
                    <div class="container-fluid form form-edit shadow">
                        <form action="/pharmacist" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <span class="error">${error_medicine_name}fкккккккккккккккккf</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-1"></div>
                                ...
                                <div class="col-md-3">
                                    <span class="error">${error_price}ff</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-1"></div>
                                ...
                                <div class="col-md-3">
                                    <span class="error">${error_quantity_packages}ff</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-1"></div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <div class="col-md-7 group-input">
                                        <input  name="quantity_in_package" value="${medicine.quantityInPackage}" class="form-control"
                                                type="number" min="1" step="1"  required
                                        />
                                        <span class="helper"> <fmt:message bundle="${bundle}"
                                                                           key="page.message.helper.quantity"/></span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <span class="error">${error_need_prescription}ddd</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-1"></div>
