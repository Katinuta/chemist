                    ...
                    <c:forEach var="prescription" items="${prescriptions}">
                        <tr>
                            ...
                            <td><input type="date" name="date_begin" class="begin" data-date=""
                                       data-date-format="DD MMMM YYYY" value="${prescription.dateBegin}" required
                                       readonly/>
                            ...
                            <form action="/chemist/doctor" method="post">
                                ...
                                <td>
                                    ...
                                    <input type="date" name="date_end" class="end form-control"
                                           value="${prescription.dateEnd}" required/>
                                    ...
                                    <c:otherwise>
                                    <input type="date" name="date_end" class="begin" value="${prescription.dateEnd}"
                                           required readonly/>
                                    </c:otherwise>
                                    </c:choose>
                                <td>
