...
<%--<header>--%>
    <%--<nav>--%>
        ...
        <%--&lt;%&ndash;<a class="right" href="#sign_up">Sing up</a>&ndash;%&gt;--%>
        <%--&lt;%&ndash;<a class="right" href="#sign_in">Sign in</a>&ndash;%&gt;--%>
...
<main>
    <div class="form" >
        <form action="controller">
            ...
            <label for="login"><fmt:message bundle="${bundle}" key="login"/></label>
            <input type="text" name="login" id="login" required placeholder=<fmt:message bundle="${bundle}" key="placeholder.login"/>>
            <label for="password"><fmt:message bundle="${bundle}" key="password"/></label>
