...
<html>
	...
	<body>
			...
			${error}
				<div class="form" > 
					<form action="controller" id="myform" method="post">
						...
						<div class="group">
							<input type="password" name="password" id="password" pattern="(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z]).{6,}" required
						...
						<div class="group">
							<input type="password" name="repPassword" id="repPassword"  pattern="(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z]).{6,}" required
							oninput="checkPasswords()" >
							<span class="highlight"></span>
            				<span class="bar"></span>
		...
		<footer>
				<span>Online chemist</span>
					<span class=".p">8.00-22.00</span>
					<span class=".p">Phone: +375 29 777 77 77</span>
					<span class=".p">Adrress: 220000 Minsk Alibegova street 15</span>
				<span>Contact information: <a href="mailto:chemist@chemist.com">chemist@chemist.com</a></span>
		</footer>
