...
<main>
    ...
    <div class="form">
        <form action="">
            ...
            <input type="text" name="surname" id="surname" required="required" placeholder="Your surname..">
            <label for="phone" >Phone</label>
            <input type="text" name="phone" id="phone" required="required" placeholder="Your phone..">
            ...
            <input type="password" name="repeatpassword" id="repeatpassword" required placeholder="Repeat your password...">
